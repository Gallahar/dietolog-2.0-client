...
щось пішло не так`,
	...
	prepared_solutions: {
		...
		col_1_part_1:
			'<p>Також Ви можете обрати та замовити <b>готову</b> програму харчування з урахуванням Ваших цілей та потреб. Це готовий план харчування, який допоможе Вам скоригувати свою вагу до норми та навчить основам збалансованого харчування.</p>',
		col_1_part_2:
		...
		constructor_heading: 'Конструктор меню\n та його переваги',
		constructor_1:
